...
_supress nautilus		"Gtk-CRITICAL\|GLib-GObject"

function weather() {
	curl -k "https://wttr.in/${1:-Teddington}"
}
...
# Set completion for gnuplot
complete -f -X '!*.gnu' gnuplot
complete -f -X '!*.gnu' gnuplot4
complete -f -X '!*.gnu' gnuplot4-qt
...
alias ...='cd ../..'
alias ....='cd ../../..'
alias never_gonna_give='cvlc /home/jamie/Music/.astley.m4a &>/dev/null'
alias soul='cvlc /home/jamie/Music/.gold.m4a &>/dev/null'
alias flash='cvlc /home/jamie/Music/.flash.m4a &>/dev/null'
alias harvey='cvlc /home/jamie/Music/.mad.m4a &>/dev/null'
alias ps3='sudo sixad -stop; sudo sixad -start; sudo sixad -stop'
alias cloud='mkdir ~/WD\ Cloud; sshfs cloud:/DataVolume/shares/Public/ /home/jamie/WD\ Cloud/'
alias plot='gnuplot plot*.gnu'
alias beep='measurement_beeper'
alias vlc='vlc &>/dev/null'
alias cvlc='cvlc &>/dev/null'
